    ...
    <div class="contents index">
        ...
        <div class="reserve theater-list-box">
            ...
            <div class="theater-list">
                <div class="theater-tit" id="titleBox">
                    <p><a href="/film/detailsPage.jsp?id=${filmId.film_id}"
                          title="movieTitle">${filmId.title}</a></p>
                    <p class="information"><span>상영시간</span> ${filmId.length} 분</p>
                </div>

<%--                &lt;%&ndash;    내부의 반복되야되는 상영 출력 start                &ndash;%&gt;--%>
...
<%--                    </div>--%>
<%--                </div>--%>
<%--                &lt;%&ndash;    내부의 반복되야되는 상영 출력 end                &ndash;%&gt;--%>
            </div>
        </div>
    </div>
</div>
